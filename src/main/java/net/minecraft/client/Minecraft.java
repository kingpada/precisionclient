...
import net.minecraft.src.chat.ChatAllowedCharacters;
...
import net.minecraft.src.enums.EnumOS;
...
import net.minecraft.src.items.objects.ItemRenderer;
...
import net.minecraft.src.network.ServerData;
import net.minecraft.src.network.interfaces.INetworkManager;
import net.minecraft.src.packet.packets.Packet3Chat;
import net.minecraft.src.particle.EffectRenderer;
import net.minecraft.src.player.controller.KeyBinding;
import net.minecraft.src.player.controller.MouseHelper;
import net.minecraft.src.player.controller.MovementInputFromOptions;
import net.minecraft.src.player.controller.PlayerControllerMP;
import net.minecraft.src.position.MovingObjectPosition;
import net.minecraft.src.render.*;
import net.minecraft.src.render.objects.RenderBlocks;
import net.minecraft.src.sounds.SoundManager;
import net.minecraft.src.stats.StatCollector;
import net.minecraft.src.stats.StatStringFormatKeyInv;
import net.minecraft.src.stats.data.achievements.AchievementList;
import net.minecraft.src.texture.GLAllocation;
import net.minecraft.src.texture.TextureManager;
import net.minecraft.src.texture.TexturePackList;
import net.minecraft.src.utils.*;
