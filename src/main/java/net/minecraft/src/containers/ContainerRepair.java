...
public class ContainerRepair extends Container {
    ...
    public static IInventory getRepairInputInventory(ContainerRepair par0ContainerRepair) {
        return par0ContainerRepair.inputSlots;
    }

    public static int getStackSizeUsedInRepair(ContainerRepair par0ContainerRepair) {
