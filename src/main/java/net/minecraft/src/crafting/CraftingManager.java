...
import net.minecraft.src.crafting.recipes.ShapedRecipes;
import net.minecraft.src.crafting.recipes.ShapelessRecipes;
...
import net.minecraft.src.crafting.recipes.*;
