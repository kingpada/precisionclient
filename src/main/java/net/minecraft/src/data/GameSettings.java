package net.minecraft.src.data;
...
import net.minecraft.src.enums.EnumOptionsHelper;
import net.minecraft.src.gui.screens.GuiNewChat;
import net.minecraft.src.nbt.NBTTagCompound;
import net.minecraft.src.packet.packets.Packet204ClientInfo;
