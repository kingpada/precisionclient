...
import net.minecraft.src.blocks.BlockBed;
...
import net.minecraft.src.enums.EnumAction;
import net.minecraft.src.enums.EnumGameType;
import net.minecraft.src.enums.EnumStatus;
import net.minecraft.src.gui.Icon;
import net.minecraft.src.inventory.IInventory;
import net.minecraft.src.inventory.InventoryEnderChest;
...
import net.minecraft.src.network.interfaces.ICommandSender;
import net.minecraft.src.player.actions.DamageSource;
import net.minecraft.src.player.controller.PlayerCapabilities;
import net.minecraft.src.potion.Potion;
import net.minecraft.src.scoreboard.Scoreboard;
import net.minecraft.src.scoreboard.score.Score;
import net.minecraft.src.scoreboard.score.ScoreObjective;
import net.minecraft.src.scoreboard.score.ScoreObjectiveCriteria;
import net.minecraft.src.scoreboard.score.ScorePlayerTeam;
import net.minecraft.src.stats.data.FoodStats;
