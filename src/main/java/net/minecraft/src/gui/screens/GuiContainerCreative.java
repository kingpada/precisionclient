...
import net.minecraft.src.creative.CreativeCrafting;
...
import net.minecraft.src.inventory.InventoryEffectRenderer;
...
import net.minecraft.src.slot.objects.SlotCreativeInventory;
