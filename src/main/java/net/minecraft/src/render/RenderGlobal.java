...
import net.minecraft.src.items.objects.ItemDye;
import net.minecraft.src.items.objects.ItemRecord;
...
import net.minecraft.src.render.misc.DestroyBlockProgress;
