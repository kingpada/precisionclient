...
import net.minecraft.src.model.objects.ModelZombie;
import net.minecraft.src.model.objects.ModelZombieVillager;
import net.minecraft.src.render.objects.RenderBiped;
