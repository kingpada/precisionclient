package net.minecraft.src.texture;
...
import net.minecraft.src.texture.stitcher.StitchHolder;
import net.minecraft.src.texture.stitcher.StitchSlot;
import net.minecraft.src.texture.stitcher.Stitcher;
import net.minecraft.src.texture.stitcher.StitcherException;
